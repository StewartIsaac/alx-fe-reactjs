...
export default function HomePage() {
    ...
    return (
        <div className="container mx-auto p-4 hover:shadow-md">
            <h1 className="text-3xl font-bold mb-4 sm:mb-8 sm:text-5xl">Recipe Sharing App</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {recipes.map((recipe) => (
                    <div key={recipe.id} className="bg-white rounded-lg shadow-md p-4">
                        <img src={recipe.image} alt={recipe.title} className="w-full h-32 sm:h-52 object-cover rounded-t-lg" />
